...
function change(event)
{
	...
	if(document.getElementById("Effekt2_Input").checked==true)
	{
		img=effects.effekt2(img,{});
	}
...
var effects={};
effects.effekt2=function (imagedata, options)
{
	var img=imagedata;
	for(var i=0; i<img.data.length; i+=16)
	{
		var r=(img.data[i+0]+img.data[i+4]+img.data[i+8]+img.data[i+12])/4;
		var g=(img.data[i+1]+img.data[i+5]+img.data[i+9]+img.data[i+13])/4;
		var b=(img.data[i+2]+img.data[i+6]+img.data[i+10]+img.data[i+14])/4;
		var a=(img.data[i+3]+img.data[i+7]+img.data[i+11]+img.data[i+15])/4;
		
		
		
		
		img.data[i+0]=img.data[i+4]=img.data[i+8]=img.data[i+12]=r;
		img.data[i+1]=img.data[i+5]=img.data[i+9]=img.data[i+13]=g;
		img.data[i+2]=img.data[i+6]=img.data[i+10]=img.data[i+14]=b;
		img.data[i+3]=img.data[i+7]=img.data[i+11]=img.data[i+15]=a;
